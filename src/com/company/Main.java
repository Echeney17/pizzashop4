...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Transaction trans1 = new Transaction(1, order1, PaymentType.cash, "1 Plain");

        Menu menu1 = new Menu(1, "Plain",6.69);
        Menu menu2 = new Menu(2, "Meat", 7.69);
        Menu menu3 = new Menu(3, "Extra", 8.69);
        Menu menu4 = new Menu(4, "Veg", 9.69);
